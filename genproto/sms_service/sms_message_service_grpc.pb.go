...
func (c *smsServiceClient) ConfirmOtp(ctx context.Context, in *ConfirmOtpRequest, opts ...grpc.CallOption) (*ConfirmOtpResponse, error) {
...
func (UnimplementedSmsServiceServer) ConfirmOtp(context.Context, *ConfirmOtpRequest) (*ConfirmOtpResponse, error) {
