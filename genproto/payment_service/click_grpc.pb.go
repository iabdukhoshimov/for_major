...
type ClickServiceClient interface {
	...
	GenerateClickLinkSvod(ctx context.Context, in *ClickLinkSvodRequest, opts ...grpc.CallOption) (*ClickLinkSvodResponse, error)
}
...
func (c *clickServiceClient) GenerateClickLinkSvod(ctx context.Context, in *ClickLinkSvodRequest, opts ...grpc.CallOption) (*ClickLinkSvodResponse, error) {
	out := new(ClickLinkSvodResponse)
	err := c.cc.Invoke(ctx, "/payments.ClickService/GenerateClickLinkSvod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClickServiceServer interface {
	...
	GenerateClickLinkSvod(context.Context, *ClickLinkSvodRequest) (*ClickLinkSvodResponse, error)
...
func (UnimplementedClickServiceServer) GenerateClickLinkSvod(context.Context, *ClickLinkSvodRequest) (*ClickLinkSvodResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateClickLinkSvod not implemented")
}
...
func _ClickService_GenerateClickLinkSvod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClickLinkSvodRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClickServiceServer).GenerateClickLinkSvod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payments.ClickService/GenerateClickLinkSvod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClickServiceServer).GenerateClickLinkSvod(ctx, req.(*ClickLinkSvodRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ClickService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GenerateClickLinkSvod",
			Handler:    _ClickService_GenerateClickLinkSvod_Handler,
		},
	},
